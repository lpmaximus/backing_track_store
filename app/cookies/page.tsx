...
export const metadata: Metadata = {
  title: "Política de Cookies — BackingTrack.store",
  description: "Quais cookies o backingtrack.store usa, para que servem e como gerenciá-los.",
};
...
export default function CookiesPage() {
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column" }}>
      ...
      <LegalPage title="Política de Cookies" effectiveDate="18 de julho de 2026">
        <p>
